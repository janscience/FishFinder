/*
  ScreenMenu - Select actions from a menu.
...
public:
  ...
  static const int MaxText = 32;

  // Function type for menu actions.
  typedef void (*Action)(int);

  // Constructor.
  ScreenMenu(Display *screen=0, PushButtons *buttons=0);
  ...
  void addMenu(const char *text, ScreenMenu &menu);
